...
int main(int argc, char *argv[])
{
    ...
    minimo = minima_temp(array);
    printf("\n La menor temperatura registrada historicamente es %d\n\n", minimo);

    temp_maximas(array,output_max);


    printf("Las temperaturas maximas registradas en cada año son:\n\n");
    dump(output_max, YEARS);

    precipitaciones(array, output_month);

    printf("Los meses en los que se registraron la mayor precipitacion son:\n\n");

    array_dump_month(output_month);
